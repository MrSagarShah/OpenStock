...
export const metadata: Metadata = {
  title: 'Terms of Service | Good Thoughts Stocks',
      ...
      <div className="space-y-12">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-yellow-200/80 leading-relaxed">
                **Good Thoughts Stocks is an educational and analysis tool, not a financial advisor.**
        ...
        <div className="text-center pt-8 border-t border-gray-800">
          <p className="text-gray-500">
            Questions? Visit <a href="https://goodthoughts.in" className="text-teal-400 hover:underline">goodthoughts.in</a>
          </p>
        </div>
      </div>
    </div>
