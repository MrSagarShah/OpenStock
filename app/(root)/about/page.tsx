    ...
    return (
        <div className="mx-auto max-w-3xl py-12 text-gray-200">
            <div className="mb-8 flex items-center gap-3">
                <span className="flex h-14 w-14 items-center justify-center rounded-xl bg-[#065f46] text-gray-900 font-black text-xl">GT</span>
                <div>
                    <h1 className="text-3xl font-bold">Good Thoughts Stocks</h1>
                    <p className="text-sm text-[#065f46]">A Good Thoughts product</p>
                </div>
            </div>
            ...
            <p className="mb-4 text-gray-300">
                ...
                <a href="https://financial.goodthoughts.in" className="text-[#065f46] hover:underline">
